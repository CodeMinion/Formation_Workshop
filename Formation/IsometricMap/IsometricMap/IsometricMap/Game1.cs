 ...
 * SIG-Games Workshop
 * 
 * Main Topic: Formations
 * Sub Topics: Squad Behavior
 *             
 * 
 * Purpose: The main goals of this workshop is to give a simple introduction
 *          to formations. This workshop uses a squad structure to handle the 
 *          behavior of the formations. 
 
 *          As an alternate goal this workshops attempts to introduce
 *          some design patterns along with their implementation and
 *          usage. 
 *          Composite Pattern: Used to create the squad hierarchy.
 *          Factory Method: Used to create each individual formation
 *                          for the goblin squad.
 *          
...
namespace IsometricMap
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        GameEntity m_Goblin;
        List<GoblinLumberjack> m_GoblinList;
        ...
        CompositeSquad m_goblinSquad;

        List<Formation> m_FormationList;
        int m_currFormationIndex = 0;
        #endregion
        ...
        protected override void LoadContent()
        {
            ...
            */
            ...
            {
                m_GoblinList[i].SetSpriteTexture(Content.Load<Texture2D>((m_GoblinList[i]).GetResroucePath()));
            }
            ...
            {
                Texture2D lumberMillText = Content.Load<Texture2D>(m_LumberMills[i].GetResourceFile());

                m_LumberMills[i].SetSpriteTexture(lumberMillText);
            }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if(!currState.Equals(prevState))
            {
                if (Keyboard.GetState().IsKeyDown(Keys.F5))
                {
                    ...
                    m_currFormationIndex = (m_currFormationIndex +1 ) % m_FormationList.Count;
                    m_goblinSquad.SetFormation(m_FormationList[m_currFormationIndex]);
                }
                //    ResetMap();
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            m_goblinSquad.Draw(spriteBatch);
            spriteBatch.End();
